  ...
  const testimonials = [
    {
      ...
      content: "MangoMind ช่วยให้การเลือกมะม่วงสุกเป็นเรื่องง่ายมาก ใช้งานง่ายและผลลัพธ์แม่นยำ",
      rating: 5,
    ...
    },
    {
      ...
      content: "ระบบวิเคราะห์ภาพของ MangoMind ช่วยให้การคัดเลือกมะม่วงมีประสิทธิภาพมากขึ้น",
      rating: 5,
    ...
    },
    {
      ...
      name: "วิชัย เก่งมาก",
      role: "ผู้บริโภค",
      content: "MangoMind ช่วยให้เลือกมะม่วงสุกได้ง่ายมาก ช่วยประหยัดเวลาในการเลือกซื้อ",
      rating: 4,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-4">
            ฟังเสียงจากผู้ใช้จริงที่ได้สัมผัสประสบการณ์การตรวจสอบความสุกของมะม่วงด้วย MangoMind
          </p>
        </div>
        ...
        <div className="text-center mt-8 sm:mt-12 lg:mt-16">
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 max-w-2xl mx-auto px-4">
              เข้าร่วมกับผู้ใช้หลายพันคนที่ไว้วางใจ MangoMind 
